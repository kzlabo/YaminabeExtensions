...
namespace YaminabeExtensions.Core
{
    ...
    public static class DoubleExtensions
    {
        ...
        /// <summary>
        /// <see cref="System.Math.Round(double, int, System.MidpointRounding)"/> のラップメソッドを提供します。
        /// </summary>
        ...
        /// 丸めた結果を返却します。
        /// </returns>
        public static double Round(this double value, int digits = 0, System.MidpointRounding mode = System.MidpointRounding.ToEven)
        {
